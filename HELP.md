...
* [Configure the Spring AOT Plugin](https://docs.spring.io/spring-native/docs/0.11.2-SNAPSHOT/reference/htmlsingle/#spring-aot-maven)
...
```
$ docker run --rm reto:0.0.1-SNAPSHOT
```
